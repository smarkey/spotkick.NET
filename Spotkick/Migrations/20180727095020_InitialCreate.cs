        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TrackerCount = table.Column<int>(nullable: false),
                    UpcomingEventCount = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Artists", x => x.PrimaryKeyId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(nullable: false),
                    ArtistPrimaryKeyId = table.Column<int>(nullable: true),
                    Url = table.Column<string>(nullable: true),
                    OnSaleDateTime = table.Column<DateTime>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Events_Artists_ArtistPrimaryKeyId",
                        column: x => x.ArtistPrimaryKeyId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Events_ArtistPrimaryKeyId",
                table: "Events",
                column: "ArtistPrimaryKeyId");
